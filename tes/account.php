...
<head>
    ...
    <title>TES Focal Person - Account Settings</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process.php" method="POST">
                                    <?php 
                                        $check_acc = $_SESSION['user_data_tes']['email'];
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                        <button type="submit" class="btn btn-danger" name="edit_profile_tes">Yes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="author">
                                    ...
                                    ?>
                                        ...
                                        <form action="process.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                            <button type="submit" name="change_pic_tes" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Profile Picture">Update Profile Picture</button>
                                        </form>
                                    <?php } ?>
                                    </a>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                        <button type="submit" class="btn btn-danger" name="change_pass_tes">Yes</button>
                                    </div>
                                </form>
                                <?php } ?>
                            </div>
