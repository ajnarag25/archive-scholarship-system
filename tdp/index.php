                                    ...
                                    ?>
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="process.php" method="POST">
                                                            <input type="hidden" name="id_tdp_download" value="<?php echo $row['id'] ?>">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-primary" name="download_tdp">Download</button>
                                                        </form>
                                                    </div>
                                        ...
                                        <div class="modal fade" id="archive<?php echo $row['id'] ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title">Archive TDP Focal Person Records</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="hidden" value="<?php echo $row['date_time'] ?>" name="tdp_dt">
