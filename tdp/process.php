            ...
            if(move_uploaded_file($_FILES["file"]["tmp_name"], $destination)) {
                ...
                if($ext === 'csv'){
                    while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE){
                        ...
                        $query_code = "SELECT * FROM tdp_grantees WHERE file='$d3'";
                    ...
                    $query_code = "SELECT * FROM tdp_grantees WHERE file='$filename'";
                    ...
                    if ($result3->num_rows > 0) {
                        ...
                        $sql2 = "INSERT into tdp_grantees (date_time, file, semester, academic_yr, remarks) 
