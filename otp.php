                    ...
                    <div class="card shadow-2-strong" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <form action="process.php" method="POST">
                                ...
                                <p class="mb-5">Check your email for your OTP.</p>
                                <div class="form-outline mb-4">
                                    <input type="number" placeholder="Enter OTP" name="otp" class="form-control" required/>
                                </div>
                                <button class="btn btn-success btn-lg btn-block w-100" type="submit" name="otp_submit">Submit</button>
                                <br><br>
